...
public class CustomRecyclerView extends CustomSwipeRefreshLayout implements PrvInterface {
    ...
    private PullToRefreshRecyclerView.PagingableListener mPagingableListener;
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (mIsSwipeEnable) {
                if (findFirstCompletelyVisibleItemPosition() != 0) {
                    ...
                    CustomRecyclerView.this.setEnabled(false);
                } else {
                    CustomRecyclerView.this.setEnabled(true);
                }
            }
