...
public class CustomSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private CustomCircleImageView mCircleView;
    ...
    private CustomMaterialProgressDrawable mProgress;
    ...
    private void createProgressView() {
        mCircleView = new CustomCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
...
//                (width / 2 + circleWidth / 2), mCurrentTargetOffsetTop + circleHeight);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP: {
                //手指松开时返回原位
                mTarget.animate().translationY(0).setDuration(500).start();
